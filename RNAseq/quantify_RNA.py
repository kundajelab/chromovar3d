...
def main():
    ...
    parser.add_option('--out',dest='out',help='Out',default='/srv/gs1/projects/snyder/jzaugg/histoneQTL/RNAseq/results/SAILFISH/')
    FQ_dir='/srv/gs1/projects/montgomery/ext_shared/projects/GEUVADIS/fastq/E-GEUV-1/'
    ...
    metadata='/srv/gs1/projects/snyder/jzaugg/histoneQTL/RNAseq/data/metadata'
