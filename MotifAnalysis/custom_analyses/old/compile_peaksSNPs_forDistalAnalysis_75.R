...
DISTAL_QTLS='/srv/gsfs0/projects/snyder/oursu/histoneQTL/motif_analysis/results/2015-01-12/DistalQTL.txt'
...
first=TRUE
for (hmark in hmarks){
    qtl.f=paste('/srv/gs1/projects/snyder/jzaugg/histoneQTL/hQTL_analysis/results/20140622_newPeaks/transQTLs.prox.frag.FDR10.allChr.2000kb.',hmark,'.HiC_TH0.4.rda',sep='')
    load(qtl.f)
...
write.table(qtl_singleRow,file=DISTAL_QTLS,sep='\t',quote=F,row.names=F,col.names=F)
...
write.table(newqtl2,file='/srv/gsfs0/projects/snyder/oursu/histoneQTL/motif_analysis/results/2015-01-12/DistalQTL.txt.ChrGeneDistaltxt',sep='\t',quote=F,row.names=F,col.names=T)
write.table(newqtl_with_overlappingRNA,file='/srv/gsfs0/projects/snyder/oursu/histoneQTL/motif_analysis/results/2015-01-12/DistalQTL.txt.ChrGenePeak2.PlusOverlappedRNA.txt',sep='\t',quote=F,row.names=F,col.names=T)
